...
import sys
import os
from core.go.godag.obo_optional_attributes import OboOptionalAttrs
from core.go.godag import TypeDef
from core.go.godag import add_to_typedef
        ...
        for relationship_type, goids in rec_curr.relationship.items():
            ...
            for parent_rec in parent_recs:
                if relationship_type not in parent_rec.relationship_rev:
                    parent_rec.relationship_rev[relationship_type] = {rec_curr}
                else:
